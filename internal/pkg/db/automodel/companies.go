...
var (
	companyAllColumns            = []string{"id", "name"}
...
func (q companyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Company, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "automodel: failed to execute a one query for companies")
	}
...
func (q companyQuery) All(ctx context.Context, exec boil.ContextExecutor) (CompanySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "automodel: failed to assign all query results to Company slice")
	}
...
func (q companyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "automodel: failed to count companies rows")
	}
...
func (q companyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "automodel: failed to check if companies exists")
	}
...
func (o *Company) Rooms(mods ...qm.QueryMod) roomQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`rooms`.`company_id`=?", o.ID),
	)
...
func (companyL) LoadRooms(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCompany interface{}, mods queries.Applicator) error {
	var slice []*Company
	var object *Company
	...
	query := NewQuery(
		qm.From(`rooms`),
		qm.WhereIn(`rooms.company_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Company) AddRooms(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Room) error {
	var err error
...
func FindCompany(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Company, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "automodel: unable to select from companies")
	}
...
func (o *Company) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("automodel: no companies provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "automodel: unable to insert into companies")
	}
	...
	if err != nil {
		return errors.Wrap(err, "automodel: unable to populate default values for companies")
	}
...
func (o *Company) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("automodel: unable to update companies, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to update companies row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "automodel: failed to get rows affected by update for companies")
	}
...
func (q companyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to update all for companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to retrieve rows affected for companies")
	}
...
func (o CompanySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to update all in company slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to retrieve rows affected all in update all company")
	}
	return rowsAff, nil
}
...
func (o *Company) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("automodel: no companies provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("automodel: unable to upsert companies, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "automodel: unable to upsert for companies")
	}
	...
	if err != nil {
		return errors.Wrap(err, "automodel: unable to retrieve unique values for companies")
	}
...
func (o *Company) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("automodel: no Company provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to delete from companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "automodel: failed to get rows affected by delete for companies")
	}
...
func (q companyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("automodel: no companyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to delete all from companies")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "automodel: failed to get rows affected by deleteall for companies")
	}
...
func (o CompanySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "automodel: unable to delete all from company slice")
	}
...
func (o *CompanySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "automodel: unable to reload all in CompanySlice")
	}
...
func CompanyExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "automodel: unable to check if companies exists")
	}
